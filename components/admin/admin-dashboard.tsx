     ...
     return (
          <div className="space-y-8">
               ...
               <div className="flex gap-2 flex-wrap">
                    {['ALL', 'PENDING', 'VERIFYING', 'COMPLETED', 'CANCELLED'].map((status) => (
                         <button
                              key={status}
...
function OrderCard({
     ...
     const destinationData = order.destination_data as { bank?: string; phone?: string; id_number?: string } | null;
                    ...
                    <div className="border-t-4 border-[#262626] p-4 bg-gray-50">
                         <div className="grid md:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-3">
                                   ...
                                   {destinationData ? (
                                        <div className="mono text-xs space-y-1">
                                             <p><span className="opacity-50">Banco:</span> <span className="font-bold">{destinationData.bank || 'N/A'}</span></p>
                                             <p><span className="opacity-50">Teléfono:</span> <span className="font-bold">{destinationData.phone || 'N/A'}</span></p>
                                             <p><span className="opacity-50">Cédula:</span> <span className="font-bold">{destinationData.id_number || 'N/A'}</span></p>
                                        </div>
                                   ) : (
