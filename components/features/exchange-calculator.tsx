...
export const ExchangeTerminal: React.FC = () => {
     ...
     const validatePhone = (phone: string) => /^04\d{9}$/.test(phone.replace(/\s/g, ''));
                                   ...
                                   {paymentInfo && (
                                        <div className="w-full max-w-md space-y-4 text-left">
                                             ...
                                             <a
                                                  ...
                                                  className="block w-full bg-green-600 text-white p-4 text-center font-black uppercase mono border-4 border-[#262626] hover:bg-green-700 transition-colors"
                                             >
