     ...
     return (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12">
               ...
               <div className="lg:col-span-8 space-y-12">
                    <Slab className="p-4 sm:p-6 md:p-10 relative overflow-hidden min-h-[450px] sm:min-h-[550px]">
                         {/* Step indicators - absolute on desktop only */}
                         <div className="hidden sm:flex sm:absolute sm:top-0 sm:right-0">
                              ...
                              <div className="space-y-6 sm:space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                   <div className="space-y-3">
                                        <label className="mono text-[10px] sm:text-xs font-black uppercase tracking-widest flex items-center gap-2">
                                             <span className="w-2 h-2 sm:w-3 sm:h-3 bg-[#FF4D00]"></span> Tú envías (PayPal USD)
                                        </label>
                                        {/* Step indicators - mobile only, below label */}
                                        <div className="flex sm:hidden gap-2">
                                             <div className="px-3 py-1.5 border-2 border-[#262626] mono text-xs font-bold bg-[#262626] text-white">STEP_01</div>
                                             <div className="px-3 py-1.5 border-2 border-[#262626] mono text-xs font-bold bg-white opacity-30">STEP_02</div>
                                        </div>
                                        <div className="relative group">
                                             <span className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 font-black text-2xl sm:text-4xl opacity-20">$</span>
                                             <input
                                                  type="number"
                                                  ...
                                                  className="w-full bg-gray-50 border-b-4 sm:border-b-8 border-[#262626] p-4 sm:p-8 pl-12 sm:pl-16 text-3xl sm:text-5xl font-black mono focus:bg-white transition-all outline-none"
                                             />
                                        </div>
                                   ...
                                   <div className="flex items-center gap-4 sm:gap-6">
                                        ...
                                        <div className="w-12 h-12 sm:w-16 sm:h-16 border-4 border-[#262626] flex items-center justify-center rotate-45 hover:rotate-0 transition-transform duration-500 bg-white">
                                             <ICONS.Exchange className="-rotate-45 w-5 h-5 sm:w-6 sm:h-6" />
                                        </div>
                                        <div className="h-1 flex-1 bg-[#262626]"></div>
                                   </div>
                                   ...
                                   <Slab dark className="p-4 sm:p-8 bg-[#FF4D00] border-[#262626] text-white cursor-pointer" onClick={handleProcess}>
                                        <div className="flex flex-row items-center justify-center gap-4 sm:gap-6">
                                             <span className="text-sm sm:text-xl font-black uppercase tracking-wide sm:tracking-widest">Continuar Proceso</span>
                                             <div className="flex items-center gap-1">
                                                  <ICONS.ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 animate-[pulse_1s_ease-in-out_infinite]" />
                                                  <ICONS.ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 animate-[pulse_1s_ease-in-out_0.2s_infinite]" />
                                                  <ICONS.ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 animate-[pulse_1s_ease-in-out_0.4s_infinite]" />
                                             </div>
                                        </div>
                                   </Slab>
                              </div>
                         ...
                         {step === AppStep.VALIDATION && (
                              <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                   <div className="space-y-3">
                                        <h3 className="mono text-lg sm:text-2xl font-black uppercase underline decoration-4 decoration-[#FF4D00] underline-offset-4">Datos de Destino</h3>
                                        {/* Step indicators - mobile only */}
                                        <div className="flex sm:hidden gap-2">
                                             <div className="px-3 py-1.5 border-2 border-[#262626] mono text-xs font-bold bg-white opacity-30">STEP_01</div>
                                             <div className="px-3 py-1.5 border-2 border-[#262626] mono text-xs font-bold bg-[#262626] text-white">STEP_02</div>
                                        </div>
                                   </div>
                                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                        <div className="space-y-2">
                                             ...
                                             <input
                                                  className={`w-full border-2 sm:border-4 ${errors.email ? 'border-[#FF4D00] bg-red-50' : 'border-[#262626]'} p-3 sm:p-4 font-bold mono text-sm focus:bg-gray-50 outline-none`}
                                        ...
                                        <div className="space-y-2">
                                             ...
                                             <select
                                                  className="w-full border-2 sm:border-4 border-[#262626] p-3 sm:p-4 font-bold mono text-sm appearance-none bg-white outline-none"
                                                  value={data.bank}
                                   ...
                                   <div className="bg-orange-50 p-3 sm:p-4 border-l-4 sm:border-l-8 border-[#FF4D00]">
                                        <p className="mono text-[9px] sm:text-[10px] font-bold leading-tight uppercase">ATENCIÓN: Solo aceptamos pagos de cuentas verificadas coincidentes con el titular bancario.</p>
                                   </div>

                                   <div className="flex gap-3 sm:gap-4 pt-4">
                                        <Slab className="w-1/3 p-4 sm:p-6 text-center text-sm sm:text-base font-black uppercase mono cursor-pointer" onClick={() => setStep(AppStep.QUOTATION)}>Volver</Slab>
                                        <Slab
                                             dark
                                             className={`flex-1 p-4 sm:p-6 text-center text-base sm:text-xl font-black uppercase tracking-wider sm:tracking-widest bg-[#FF4D00] ${isSubmitting ? 'opacity-50 cursor-wait' : 'cursor-pointer'}`}
